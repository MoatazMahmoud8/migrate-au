...
export interface VisaEntry {
  ...
  subclasses: string[];
  conditions: string[];
  /** Government application fee for primary applicant (AUD) */
  fee?: string;
  url: string;
}
...
export const ALL_VISAS: VisaEntry[] = [
  ...
  },
  {
    ...
    conditions: ['Citizen of eligible Pacific Island country or Timor-Leste', 'Selected through annual ballot', 'Must meet health, character, English requirements'],    fee: 'AUD $505',    url: 'https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/pacific-engagement',
  },
  {
  ...
  },
  {
    ...
    fee: 'AUD $5,000 (3yr) / AUD $10,000 (5yr)',
  ...
  },
  {
    ...
    fee: 'Free (granted automatically)',
