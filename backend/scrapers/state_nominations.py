...
STATES = [
    ...
    },
    {
        ...
        "name": "Victoria",
        "topic": "state_VIC",
        "url": "https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/skilled-nominated-190/vic",
        "selector": "h1, h2, h3, .intro, .alert, p strong",
        "icon": "🔵",
    },
    {
        "code": "QLD",
    ...
    },
    {
        ...
        "topic": "state_ACT",
        "url": "https://www.act.gov.au/migration/skilled-migrants/act-government-nomination",
        "selector": "h2, h3, .content p, .alert",
        "icon": "🟣",
    },
    {
        "code": "NT",
        ...
        "selector": "h2, h3, .article-title, .alert, p",
        "icon": "🟠",
    },
]
...
def scrape(db) -> list[dict]:
    ...
    for state in STATES:
        ...
        try:
            resp = requests.get(state["url"], headers=HEADERS, timeout=20)
